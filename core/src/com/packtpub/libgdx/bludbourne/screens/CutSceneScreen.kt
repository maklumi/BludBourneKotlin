...
class CutSceneScreen(val _game: BludBourne) : MainGameScreen(_game) {
    ...
    private fun getCutsceneAction(): Action {
        ...
        return Actions.sequence(
                ...
                Actions.addAction(ScreenTransitionAction.transition(ScreenTransitionAction.ScreenTransitionType.FADE_IN, 3f), _transitionActor),
                Actions.delay(3f),
                ...
                Actions.delay(5f),
                Actions.addAction(ScreenTransitionAction.transition(ScreenTransitionAction.ScreenTransitionType.FADE_OUT, 3f), _transitionActor),
                Actions.delay(3f),
